              ...
              <div className="flex flex-col items-center w-full lg:w-auto">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 w-full max-w-sm lg:max-w-none">
                  ...
                  <button
                    ...
                    className="flex flex-col items-center bg-white/15 hover:bg-white/25 rounded-lg sm:rounded-xl p-3 sm:p-4 w-full h-20 sm:h-24 text-white/90 transition-all duration-200 hover:scale-105 border border-white/10"
                  >
